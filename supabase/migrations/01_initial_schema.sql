...
CREATE TABLE quiz_attempts (
    ...
    last_answered_question_id uuid REFERENCES questions(id) ON DELETE CASCADE,
...
CREATE INDEX idx_incorrect_responses_attempt ON incorrect_responses(quiz_attempt_id);
CREATE INDEX idx_incorrect_responses_user ON incorrect_responses(user_id);
